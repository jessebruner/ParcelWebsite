    ...
    sections: [
      {
        ...
        paragraphs: [
          "Your bylaws set the date, the notice period, the quorum, and the order of business. Your state's homeowner association act sets the floor those bylaws cannot drop below. Read both before you set anything.",
          "When the bylaws and the statute disagree, the statute wins.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Send written notice to every member at the address the association keeps on file. Most states require a set number of days of lead time. Your bylaws may ask for more, and when they do, the longer period stands.",
          "The notice names the date, the time, the place, and the matters on the agenda, including the board election. Keep a copy of what you sent and when. If someone contests the meeting later, that copy is what settles it.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Owners elect the board at the annual meeting. If your documents allow electronic ballots or proxies, follow the exact procedure they set. Count them in the open. Record the result in the minutes. Two officers sign anything with legal weight.",
        ],
      },
      {
        heading: "Plan for the short count and run the room",
        paragraphs: [
          "Quorum is the minimum number of votes present for the meeting to count. If you fall short, most states let you adjourn and reconvene, often with a lower bar. Know your number before the meeting so nobody is guessing in the room.",
      ...
      },
      {
        ...
        paragraphs: [
          "The annual meeting sits on the year's quiet work: the dues billed and collected, the books kept current, the notices sent and filed, and the election run. Common Parcel handles that administrative record for self-managed associations so volunteer directors get their evenings back.",
        ],
        list: {
          title: "Run sheet checklist",
          items: [
            "Read bylaws and state act to confirm notice windows and quorum thresholds",
            ...
            "Tally ballots openly with two officers signing official results",
